...
const config = {
  ...
  employees: [
    { id: "akiva", name: "Akiva", email: "akiva@example.invalid", accent: "#e10000" },
...
const event = {
  id: "calendar-event-1",
  status: "confirmed",
  summary: "Khari Jackson: Studio Rental (Smooth Studios)",
...
Name: Khari Jackson
Phone: +13864738927
Email: kharithevisionary@icloud.com
Price: $50.00
Paid Online: $50.00
...
test("parses the exact Calendar description fields", () => {
  ...
  assert.equal(parsed.name, "Khari Jackson");
