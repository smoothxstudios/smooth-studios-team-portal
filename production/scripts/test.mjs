...
}else mf=new Miniflare({modules:true,scriptPath:'.work/worker/worker.js',compatibilityDate:'2026-09-09',compatibilityFlags:['nodejs_compat'],d1Databases:['DB'],bindings:{APP_ORIGIN:origin,BETTER_AUTH_SECRET:'test-only-secret-with-more-than-32-characters'},serviceBindings:{ASSETS:()=>new Response('Test assets')}});
try{
