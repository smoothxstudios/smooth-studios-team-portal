...
export const env={APP_ORIGIN:'https://test.invalid',BETTER_AUTH_SECRET:'test-only-secret-with-more-than-32-characters',ASSETS:{fetch:async request=>testAssets(request)},DB:{
